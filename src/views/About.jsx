  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-20">
        ...
        >
          <div className="flex flex-col items-center gap-10 sm:flex-row sm:items-start sm:gap-32">
    <ul className="flex flex-col gap-5 text-center sm:text-start sm:items-start">
      <li>
