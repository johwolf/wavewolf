      ...
      <div className="overflow-hidden pb-5">
        <div className="relative">
          <div className="bg-primary-500">
            <div className="container mx-auto grid grid-cols-2 justify-items-center gap-y-20 px-2 py-20 sm:px-4 lg:justify-items-start lg:pl-16">
              {/* Linker Textbereich */}
              <div className="col-span-2 w-[280px] lg:col-span-1 lg:w-auto lg:text-left">
                ...
                <ReactTyped
                  ...
                  strings={["Surfen mit Stil", "für lokale Unternehmen"]}
                  typeSpeed={40}
                  backSpeed={50}
                  loop
                />
